...
**Last updated:** 2026-06-28 (audit — `feat/UI-fixes` branch: parent self-enrolment, VAT gross refactor, nav)

**Branch note:** Latest work on `feat/UI-fixes` (`ed1294e`). One unstaged file: `PaymentDetailDrawer.tsx` (document link styling).
...
| **1F** | Admin dashboard | 🟡 ~68% | Operations overview; notification blast; people CSV export |
...
| Grow G7 settings + verify | [finance/stage-g7-settings-cleanup.md](plans/finance/stage-g7-settings-cleanup.md) | ✅ | ✅ | `GrowSettingsForm`, `verify-grow-credentials` — **live sandbox E2E still manual** |
| **Age override (PR A)** | [archive/age-override-pr-a.md](plans/archive/age-override-pr-a.md) | ✅ `260001` | ✅ | Complete |
...
| --- | --- | --- |
| **0** | Finish `feat/UI-fixes` — commit `PaymentDetailDrawer` tweak; merge to main | Current branch |
| **1** | **Admin operations overview** | [admin-overview-dashboard.md](plans/admin-overview-dashboard.md) |
| **2** | **Parent portal polish** — contact prefs + upcoming sessions | [parent-portal-polish.md](plans/parent-portal-polish.md) |
| **3** | Grow live sandbox E2E | [grow-live-e2e-verification.md](plans/grow-live-e2e-verification.md) |
| **4** | Notification blast composer | [notification-blast-composer.md](plans/notification-blast-composer.md) |
| **5** | Teachers admin CRUD | [teachers-admin-module.md](plans/teachers-admin-module.md) |
| **6** | PR B + parent self-enrolment manual smoke | Before pilot launch |
