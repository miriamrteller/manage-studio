...
| Native scheduling (calendar + slot booking + Google Calendar) | [scheduling/00-overview.md](plans/scheduling/00-overview.md) | 🟡 flags `03100`/`03200` + `03300`–`03500` schema | 🟡 in progress | Cal.com out; native book + pay; Google Calendar for free/busy + event sync |
