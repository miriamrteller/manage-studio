...
| 2026-07-05 | [V1 migration third squash](v1-migration-squash-20260705.md) | **Ready** — fold 13 incrementals into `20260608*` chain |
| 2026-07-05 | [V1 pg_cron scheduled jobs](v1-pg-cron-scheduled-jobs.md) | **Ready** — after squash; one `02600` migration |
