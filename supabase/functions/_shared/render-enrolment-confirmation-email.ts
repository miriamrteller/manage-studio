...
function buildHeadline(
  ...
  const template = input.pendingWaiver
    ? input.showStudentRow
      ? str(strings.enrollment_reserved_for_student)
      : str(strings.enrollment_reserved)
    : input.showStudentRow
      ? str(strings.enrollment_confirmed_for_student)
      : str(strings.enrollment_confirmed);
