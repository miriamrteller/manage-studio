...
export declare const OfferingSchema: z.ZodEffects<z.ZodObject<{
    ...
    price_minor: z.ZodNumber;
    currency: z.ZodDefault<z.ZodString>;
    offering_type: z.ZodDefault<z.ZodEnum<["class", "appointment"]>>;
    duration_mins: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    day_of_week: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
    start_time: z.ZodOptional<z.ZodNullable<z.ZodEffects<z.ZodString, string, string>>>;
    end_time: z.ZodOptional<z.ZodNullable<z.ZodEffects<z.ZodString, string, string>>>;
    ...
    waiver_required?: boolean | undefined;
    location?: string | null | undefined;
    offering_type?: "class" | "appointment" | undefined;
    duration_mins?: number | null | undefined;
...
export declare const EngagementSchema: z.ZodObject<{
    ...
    payment_dunning_attempt_count: z.ZodOptional<z.ZodDefault<z.ZodNumber>>;
    payment_dunning_next_at: z.ZodOptional<z.ZodNullable<z.ZodEffects<z.ZodString, string, string>>>;
    ...
    payment_dunning_attempt_count?: number | undefined;
    payment_dunning_next_at?: string | null | undefined;
}, {
    id: string;
    person_id: string;
    tenant_id: string;
...
export declare const NotificationLogSchema: z.ZodObject<{
    ...
    status: z.ZodDefault<z.ZodEnum<["sent", "delivered", "read", "failed", "bounced", "pending"]>>;
    failure_reason: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    created_at: z.ZodOptional<z.ZodEffects<z.ZodString, string, string>>;
    sent_at: z.ZodOptional<z.ZodNullable<z.ZodEffects<z.ZodString, string, string>>>;
}, "strip", z.ZodTypeAny, {
    id: string;
    tenant_id: string;
    ...
    recipient_account_member_id?: string | null | undefined;
    recipient_person_id?: string | null | undefined;
    status?: "sent" | "delivered" | "read" | "failed" | "bounced" | "pending" | undefined;
    created_at?: string | undefined;
    recipient_email?: string | null | undefined;
    recipient_phone?: string | null | undefined;
    variables?: Record<string, unknown> | null | undefined;
