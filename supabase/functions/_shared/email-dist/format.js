 ...
 */
export function formatTime(time, locale = 'he-IL') {
 ...
 */
export function formatCurrency(amountMinor, currency = 'ILS', locale = 'he-IL') {
 ...
 */
export function formatDate(date, locale = 'he-IL', options) {
