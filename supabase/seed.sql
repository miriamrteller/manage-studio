...
VALUES 
  -- Monday classes
  ('00000000-0000-0000-0000-000000000301'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'Mini Ballet 3:30pm', 1, '15:30:00', '16:15:00', 10, 15000, 'ILS', true, 'active'),
  ('00000000-0000-0000-0000-000000000302'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000202'::uuid, 'Pre-primary 4:15pm', 2, '16:15:00', '17:00:00', 16, 20000, 'ILS', true, 'active'),
  
  -- Wednesday classes
  ('00000000-0000-0000-0000-000000000303'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000203'::uuid, 'Primary 5pm', 3, '17:00:00', '17:45:00', 20, 25000, 'ILS', true, 'active'),
  ('00000000-0000-0000-0000-000000000304'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000204'::uuid, 'Grade 1 5:45pm', 4, '17:45:00', '18:30:00', 20, 30000, 'ILS', true, 'active'),
 
  -- Sunday classes
  ('00000000-0000-0000-0000-000000000307'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000201'::uuid, 'Grade 2 6:30pm', 0, '18:30:00', '19:15:00', 20, 15000, 'ILS', true, 'active'),
  ('00000000-0000-0000-0000-000000000308'::uuid, '00000000-0000-0000-0000-000000000001'::uuid, '00000000-0000-0000-0000-000000000101'::uuid, '00000000-0000-0000-0000-000000000204'::uuid, 'Grade 3 7:15pm ', 0, '19:15:00', '20:00:00', 20, 30000, 'ILS', true, 'active')
ON CONFLICT (id) DO NOTHING;
