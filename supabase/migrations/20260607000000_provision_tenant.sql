-- =============================================================================
-- Provision tenant RPCs (V3.0 operator onboarding wizard)
-- super_admin only
-- =============================================================================
...
BEGIN
  ...
  -- Seed default expense categories (SPEC migration 014 pattern)
...
GRANT EXECUTE ON FUNCTION provision_tenant(
  TEXT, TEXT, TEXT, JSONB, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, NUMERIC, BOOLEAN, TEXT
) TO authenticated;
