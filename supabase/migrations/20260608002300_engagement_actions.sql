-- =============================================================================
-- 002300: Engagement actions
-- cancel_engagement — admin cancel of pre-payment / pending engagements.
-- DEPENDENCIES: 000200, 000700 (audit_log), 001300, 001600 (payments)
-- =============================================================================
...
BEGIN
  ...
  -- pending_waiver included so admins can manually cancel paid-but-unsigned
  -- engagements (the send-waiver-reminder cron auto-cancels past-deadline ones).
  IF v_row.status NOT IN ('pending_payment', 'admin_review', 'pending_offer', 'pending_waiver') THEN
