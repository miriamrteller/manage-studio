-- =============================================================================
-- 004: Seasons, Categories, Staff, Offerings
-- staff created here so offerings.staff_id FK works in the same migration.
-- min_age / max_age are first-class typed columns on offerings (not JSONB).
-- DEPENDENCIES: 001
-- =============================================================================
