-- =============================================================================
-- 000700: Audit Log + OTP Codes + Verification Attempts
-- DEPENDENCIES: 000200
-- =============================================================================

-- ---------------------------------------------------------------------------
-- Audit log (compliance trail — insert by service_role or own-tenant clients)
-- ---------------------------------------------------------------------------
...
-- Critical: OTP codes are never exposed to clients (service_role bypasses RLS).
