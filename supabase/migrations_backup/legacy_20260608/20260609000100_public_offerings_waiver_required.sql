-- Add waiver_required to the public offerings RPC.
-- This allows the enrolment stepper to know synchronously (from context) whether
-- a class requires a waiver, eliminating the async race condition where the waiver
-- step was missing from the steps array on first render.
