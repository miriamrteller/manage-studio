  ...
  const { data: tenantConfig } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        payment_provider: (row as { payment_provider?: string }).payment_provider ?? 'stripe',
        ...
        invoicing_provider: (row as { invoicing_provider?: string }).invoicing_provider ?? 'green_invoice',
